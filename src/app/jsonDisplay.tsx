...
export type variablesJson = Record<
  string,
  {
    type: string
    dataType: string
            ...
            <div key={variableKey} className='mb-6 border p-4 rounded-lg bg-white shadow'>
              ...
              <div className='mb-2'>
                ...
                <input
                  ...
                  onChange={(e) =>
                    handleInputChange('variables', variableKey, 'type', e.target.value)
                  }
              ...
              <div className='mb-2'>
                ...
                <input
                  ...
                  onChange={(e) =>
                    handleInputChange('variables', variableKey, 'dataType', e.target.value)
                  }
                  className='w-full p-2 border border-gray-300 rounded-lg'
                />
              </div>
              <div className='mb-2'>
                ...
                <input
                  ...
                  onChange={(e) =>
                    handleInputChange('variables', variableKey, 'description', e.target.value)
                  }
                  className='w-full p-2 border border-gray-300 rounded-lg'
                />
              </div>
            ...
            <div key={limitKey} className='mb-6 border p-4 rounded-lg bg-white shadow'>
              ...
              <div className='mb-2'>
                ...
                <input
                  ...
                  onChange={(e) =>
                    handleInputChange('limits', limitKey, 'description', e.target.value)
                  }
                  className='w-full p-2 border border-gray-300 rounded-lg'
                />
              </div>
              <div className='mb-2'>
                ...
                <input
                  ...
                  onChange={(e) =>
                    handleInputChange('limits', limitKey, 'variables', e.target.value.split(', '))
                  }
                  className='w-full p-2 border border-gray-300 rounded-lg'
                />
              </div>
